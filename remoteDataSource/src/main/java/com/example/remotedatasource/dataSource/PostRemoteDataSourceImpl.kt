...
class PostRemoteDataSourceImpl(
    ...
    override suspend fun fetchPosts(): Response<PostDto> = responseCall { networkClient.get(GET_POSTS) }

    override suspend fun fetchCommentsByPostId(postId: Int): Response<CommentDto> =
